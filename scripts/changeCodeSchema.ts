...
export async function run(provider: NetworkProvider) {
  ...
  console.log('Updating Schema Code', process.env.SIGN_PROTOCOL_ADDRESS);

  await signProtocol.sendChangeCode(provider.sender(), CodeType.Schema, await compile('Schema'));
}
